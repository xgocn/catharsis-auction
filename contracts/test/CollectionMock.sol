...
contract ERC1155 is IERC1155, ERC165, CommonConstants
{
    ...
    */
    ...
    function _doSafeTransferAcceptanceCheck(address _operator, address _from, address _to, uint256 _id, uint256 _value, bytes memory _data) internal {
        ...
        // Note: if the below reverts in the onERC1155Received function of the _to address you will have an undefined revert reason returned rather than the one in the require tests.
        // If you want predictable revert reasons consider using low level _to.call() style instead so the revert does not bubble up and you can revert yourself on the ERC1155_ACCEPTED tests.
    ...
    function _doSafeBatchTransferAcceptanceCheck(address _operator, address _from, address _to, uint256[] memory _ids, uint256[] memory _values, bytes memory _data) internal {
        ...
        // Note: if the below reverts in the onERC1155BatchReceived function of the _to address you will have an undefined revert reason returned rather than the one in the require tests.
        // If you want predictable revert reasons consider using low level _to.call() style instead so the revert does not bubble up and you can revert yourself on the ERC1155_BATCH_ACCEPTED tests.
...
contract Collection is Ownable, SignerRole, ERC1155Base {
    ...
    function mint(uint256 id, Fee[] memory fees, uint256 supply, string memory uri) public virtual {
...
contract CollectionMock is Collection {
    ...
    constructor(
        ...
        Collection(name, symbol, signer, contractURI, tokenURIPrefix)
    {
        emit CreateERC1155_v1(msg.sender, name, symbol);
    }

    function mint(uint256 id, Fee[] memory fees, uint256 supply, string memory uri) public override /*onlyOwner*/ {
